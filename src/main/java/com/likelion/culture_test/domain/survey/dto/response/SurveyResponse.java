...
@Schema(description = "질문지 정보")
@Builder
public record SurveyResponse(

    @Schema(description = "질문지 ID", example = "2")
    Long surveyId,

    @Schema(description = "질문지 제목", example = "인사담당자 성향 테스트 (v1.0)")
    String title,

    @Schema(description = "메인 질문지 여부", example = "false")
    boolean isMain
) {
